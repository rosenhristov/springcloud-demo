package com.studentsservice.filter;
...
import com.studentsservice.intfc.AuditLoggingFeignClient;
...
public class AuditLogFilter extends ZuulFilter {
	...
	public Object run() {
		try {
			...
			auditLog.setEndDate(timeStamp);

			auditLog.setStartDate(ctx.get("START_TIMESTAMP") != null ? ctx.get("START_TIMESTAMP").toString() : timeStamp);
